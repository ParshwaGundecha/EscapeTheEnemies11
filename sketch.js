...
function draw() {
    ...
    if (gameState === PLAY) {
        ...
        if (score >= 100) {
            ...
            ground.velocityX = -(8 + score / 40);
            coinGroup.velocityX = -(8 + score / 40);
            coinGroup1.velocityX = -(8 + score / 40);
            pipeGroup.velocityX = -(8 + score / 40);
            binGroup.velocityX = -(8 + score / 40);
            birdGroup.velocityX = -(8 + score / 40);
        }
